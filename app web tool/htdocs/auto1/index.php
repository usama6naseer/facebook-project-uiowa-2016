    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Put your Facebook application's security to the test</h1>
                <h2>Enter Facebook application I.D below</h2>
                <!-- <hr class="intro-divider"> -->
                <!-- <form role="form" action="http://localhost/auto1/run_python.php" method="post" onSubmit="return handleClick()"> -->
                <form role="form" action="run_python.php" method="post" onSubmit="return handleClick()">
